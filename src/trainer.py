...
import numpy as np
from src.save.save import ValidWriteNifti

class Trainer:
    def __init__(self, model_name, model, loss_function_name, loss_function, dist_flag, distance_map_weight, max_iterations, eval_num, optimizer_name, defaults_path, train_loader, val_loader, to_onehot, valid_save_flag):
        ...
        self.valid_save_flag = valid_save_flag
    ...
    def validation(self, global_step, epoch_iterator_val):
        ...
        with torch.no_grad():
            for batch in epoch_iterator_val:
                ...
                if self.valid_save_flag ==1:
                    print("valid_save_flag ::")
                    ValidWriteNifti(self.defaults_path, self.model_name, self.loss_function_name, self.to_onehot, val_inputs, val_labels_, val_outputs_, global_step).forward()
    ...
    def train(self,global_step, dice_val_best, global_step_best):
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            if self.dist_flag == 0:
                ...
                # print(loss)
                # if self.train_save_flag ==1:
                #     print("train_save_flag ::")
                #     TrainWriteNifti(self.defaults_path, self.model_name, self.loss_function_name, self.to_onehot, x, y, logit_map, step).forward()
